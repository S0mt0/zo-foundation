  ...
  return (
    <section className="p-6">
      <div className="max-w-7xl mx-auto">
        <h2
          className="text-3xl xs:text-4xl font-semibold text-center bg-center bg-no-repeat mt-16 mb-10 text-gray-900 px-6 py-2 capitalize"
        ...
        <p className="text-center text-muted-foreground max-w-3xl mx-auto">
          ...
          <Link
            href="/who-we-are"
            className=" text-red-600 hover:text-blue-600 underline ml-6 underline-offset-2"
          >
            READ MORE
          </Link>
        </p>
