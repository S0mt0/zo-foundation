  ...
  return (
    <footer className="mt-14 bg-slate-800 text-stone-400 text-xs">
      <div className="max-w-7xl mx-auto">
        <div className="space-y-2 flex flex-wrap justify-center items-center gap-12 p-6">
          <address className="shrink-0 whitespace-nowrap flex items-center gap-3">
            <MapPin className="h-4 w-4 text-stone-200" />
            <span>
              16, Nkwere Street, Garki Area 11 <br /> FCT, Abuja Nigeria.
            </span>
          </address>
        ...
        <div className="bg-[#121525] p-6 text-center">
          &copy; 2025. All rights reserved. Website designed and built by{" "}
          <a href="mailto:sewkito@gmail.com">Sewkito.</a>
        </div>
      </div>
    </footer>
  );
