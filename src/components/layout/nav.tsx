  ...
  return (
    <div className="bg-green-800 text-white shadow-lg z-50 relative">
      <nav className="h-[70px] flex items-center justify-between pl-6 gap-3">
        ...
        <Link
          href="/donate"
          className="h-full bg-yellow-500 hover:bg-[#f8d152] px-5 md:px-6 flex items-center justify-center font-semibold text-green-800 hover:text-green-600 transition-all sm:text-lg gap-1.5"
        >
          Donate
        </Link>
      </nav>
